<template>
  <div class="calend">
    <FullCalendar ref="calendar" :options="calendarOptions" :plugins="calendarOptions.plugins">
      <template #eventContent="arg">
        <div :id="`tooltip-target-event-${arg.event.id}`" v-b-tooltip.hover class="fullcalendar-tooltip">
